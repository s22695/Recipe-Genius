...
public class KeycloakAuthController {
    ...
    public ResponseEntity<?> createUser(@RequestBody CreateUserRequest req) {
        ...
        authForm.add("grant_type", "password");
        authForm.add("client_id", "admin-cli");
        authForm.add("username", adminUsername);
        authForm.add("password", adminPassword);

        HttpHeaders authHeaders = new HttpHeaders();
        authHeaders.setContentType(MediaType.APPLICATION_FORM_URLENCODED);
        HttpEntity<MultiValueMap<String, String>> authRequest = new HttpEntity<>(authForm, authHeaders);
        Map<String, Object> authResp = restTemplate.postForObject(tokenUrl, authRequest, Map.class);
